...
public class JurosSimplesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           out.println("<h3><b>Valor Presente:</b>"+n1+"</h3>");
           double n2 = Double.parseDouble(request.getParameter("n2"));
           out.println("<h3><b>Juros:</b>"+n2+"</h3>");
           double n3 = Double.parseDouble(request.getParameter("n3"));
           out.println("<h3><b>Periodo:</b>"+n3+" meses</h3>");
           out.println("<hr/>");
           out.println("<h3><b>Valor Futuro:"+(n1*(1+((n2/100)*n3))));
           out.println("</body>");
           out.println("</html>");
